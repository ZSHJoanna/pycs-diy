# -*- coding: utf-8 -*-
#
# PyCS3 documentation build configuration file, created by
...
man_pages = [
    (master_doc, 'pycs3', u'PyCS3 Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'PyCS3', u'PyCS3 Documentation',
     author, 'PyCS3', 'One line description of project.',
     'Miscellaneous'),
]
