...
class TestOptim(unittest.TestCase):
    ...
    def testoptim_PS_residuals(self):
        ...
        fit_vector = pycs3.optim.optimiser.get_fit_vector(self.lcs, self.spline)  # we get the target parameter now
        mlknotstep = 200
        ...
        dic_opt = pycs3.optim.optimiser.DicOptimiser(self.lcs, fit_vector, self.spline, attachml, mlknotstep,
                                                     knotstep=20,
